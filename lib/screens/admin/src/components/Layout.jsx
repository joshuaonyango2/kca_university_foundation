        ...
        <div className="h-full px-3 py-4 overflow-y-auto">
          ...
          <div className="flex items-center mb-8 px-3">
            <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">KCA</span>
            </div>
            <span className="ml-3 text-xl font-bold text-gray-800">Foundation</span>
          </div>
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="/dashboard"
                className="flex items-center p-3 text-gray-900 rounded-lg bg-blue-50 hover:bg-blue-100"
              >
